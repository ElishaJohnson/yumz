...
export const RestaurantUpdate = (props: IRestaurantUpdateProps) => {
  ...
  const { restaurantEntity, cuisineTypes, reviews, loading, updating } = props;
          ...
          {loading ? (
            ...
            <AvForm model={isNew ? {} : restaurantEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                ...
                <AvInput id="restaurant-review" type="select" className="form-control" name="review.id">
                  <option value="" key="0" />
                  {reviews
...
const mapStateToProps = (storeState: IRootState) => ({
  ...
  reviews: storeState.review.entities,
